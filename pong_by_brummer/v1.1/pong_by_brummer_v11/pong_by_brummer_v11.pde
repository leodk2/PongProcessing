PFont scoreFont; //Declare a variable with the type PFont
...
void setup() {
  ...
  scoreFont = createFont("scoreFont");//Change the string if you want to change the font to another one in the data folder
  textFont(scoreFont);//Make the font the default
  textAlign(CENTER,CENTER);//Text allignment
